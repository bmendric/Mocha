...
class LeapMotionMouse:
    ...
    def __init__(self):
        ...
        self.mouseX,self.mouseY = self.screenWidth,self.screenHeight
        self.xNorm,self.yNorm = 0,0
        self.leapPosition = 0,0

        """
        self.rangeX = [self.screenWidth, 0] # [minX , maxX]
        self.rangeY = [self.screenHeight,0] # [minY, maxY]
        """
        # approximated ranges
        self.rangeX = [-300,300]
        self.rangeY = [0,600]
    ...
    def normalize(self):
        ...
        self.xNorm = float(x)/(abs(self.rangeX[1])+abs(self.rangeX[0]))
        self.yNorm = float(y)/(abs(self.rangeX[1])+abs(self.rangeX[0]))
